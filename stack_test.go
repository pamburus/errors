...
func TestFrameFormat(t *testing.T) {
	var tests = []struct {
		...
		Frame(initpc),
		"%+s",
		"github.com/pamburus/errors.init\n" +
			"\t.+/github.com/pamburus/errors/stack_test.go",
	}, {
		Frame(0),
		"%s",
		"unknown",
		...
		"%+v",
		"github.com/pamburus/errors.init\n" +
			"\t.+/github.com/pamburus/errors/stack_test.go:9",
	}, {
		Frame(0),
		"%v",
		"unknown:0",
...
func TestFuncname(t *testing.T) {
	tests := []struct {
		...
		{"", ""},
		{"runtime.main", "main"},
		{"github.com/pamburus/errors.funcname", "funcname"},
		{"funcname", "funcname"},
